...
class SubscriptionManager extends \Magento\Newsletter\Model\SubscriptionManager
{
    ...
    public function subscribe(string $email, int $storeId): Subscriber
    {
        ...
        if ($this->request->isPost() && $this->request->getPost('firstname')) {
            ...
            $subscriber->setGuestFirstname($firstname);
        }
        if ($this->request->isPost() && $this->request->getPost('lastname')) {
            $lastname = $this->request->getPost('lastname');
            $subscriber->setGuestLastname($lastname);
        }
        $subscriber->save();
